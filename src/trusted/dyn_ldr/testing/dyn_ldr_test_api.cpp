...
void* runTests(void* runTestParamsPtr)
{
	...
	*testResult = -1;
	...
	// NaCl is always LP32
	auto result8 = sandbox_invoke(sandbox, simpleLongAddTest, UINT_MAX - 1ul, 1ul)
	...
	*tempValPtr = 3;
	...
	int result14 = tempValPtr->sandbox_copyAndVerify([&tempValPtr](int val) { (void) tempValPtr; return val; });
